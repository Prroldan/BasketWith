...
class EventoGratuitoController (val eventFreeService: EventFreeService, val userService: UserService) {
    ...
    @PostMapping("/")
    fun newFreeEvent(@RequestBody newFreeEvent: eventoGratuitoDto) = ResponseEntity.status(HttpStatus.CREATED)
    ...
    @PutMapping("/")
    fun editFreeEvent(idEdit:UUID,@RequestBody edit: eventoGratuitoDto){
...
class EventoDePagoController (val eventPayService: EventPayService, val userService: UserService) {
    ...
    @PostMapping("/")
    fun newPayEvent(@RequestBody newPayEvent: eventodePagoDto) = ResponseEntity.status(HttpStatus.CREATED)
    ...
    @PutMapping("/")
    fun editPayEvent(idEdit:UUID,@RequestBody edit: eventodePagoDto){
